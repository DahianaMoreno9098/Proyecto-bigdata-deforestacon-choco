[README (1).md](https://github.com/user-attachments/files/29310649/README.1.md)
...
[`Pipeline_BigData_Deforestacion_Choco.ipynb`](Pipeline_BigData_Deforestacion_Choco.ipynb),
...
## Tablero de Monitoreo (Databricks Dashboard — real, publicado)

![Dashboard real](Dashboard.png)

*Tablero real, publicado en Databricks Free Edition, conectado en vivo a la tabla
`gold_hotspots_deforestacion` mediante un dataset SQL. Incluye: ranking de los 10 municipios
con más hectáreas deforestadas, distribución por causa predominante, y una tabla de zonas en
nivel de alerta Extrema/Alta. Estos no son datos simulados: provienen directamente de la capa
Gold generada por el pipeline.*

**Serving Endpoint:** la tabla Gold se expone mediante un **Databricks SQL Warehouse**
(*Serverless Starter Warehouse*), que actúa como punto único de consumo tanto para este
dashboard como para integraciones vía API con aplicaciones de campo. El acceso se controla
mediante permisos de Unity Catalog.
...
## Mockup de diseño original (referencia)

![Mockup del tablero](dashboard_mockup.png)

*Boceto de diseño elaborado antes de construir el tablero real, usado como guía visual para
definir qué KPIs y gráficos debía incluir (tarjetas KPI, semáforo de alerta regional y
tendencia anual, posteriormente simplificados en la versión publicada de Databricks).*
...
2. En **Catalog Explorer**, crea un Volume y sube el archivo
   [`AREAS_DEFORESTADAS_CHOCO_20260511.csv`](AREAS_DEFORESTADAS_CHOCO_20260511.csv).
